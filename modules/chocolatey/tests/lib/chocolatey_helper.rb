...
$chocolatey_latest_info_url = "https://artifactory.delivery.puppetlabs.net/artifactory/api/nuget/nuget/choco-pipeline-tests/Packages()?$filter=((Id%20eq%20%27chocolatey%27)%20and%20(not%20IsPrerelease))%20and%20IsLatestVersion"
